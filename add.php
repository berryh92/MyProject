...
or die(mysql_error());
 ...
 //ensure both passwords entered match
 	...
 	//encrypt password and add slashes if needed
...
$_POST['email'] = addslashes($_POST['email']);
 ...
 //insert details into database
 	...
 	$insert = "INSERT INTO login (username, password,email)
...
Use the form below to register an account with us and begin uploading your papers:

<br/>
<br/>

<h1><font face="georgia" size="5" color="black"><b>Register:</b></font></h1>
...
<input type="password" name="pass2" maxlength="10" required>
